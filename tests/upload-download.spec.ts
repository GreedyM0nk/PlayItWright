...
async function writeExcelTest(searchText: string, replaceText: string, change: ChangeConfig, filePath: string) {
...
async function readExcel(worksheet: ExcelJs.Worksheet | undefined, searchText: string): Promise<Output> {
